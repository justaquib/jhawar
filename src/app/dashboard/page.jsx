            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-x-20">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="mt-2">Revenue Left</div>
                        </div>
                        <div className="p-4 bg-green-100 rounded-xl text-gray-800">
                        <div className="font-bold text-2xl leading-none">$500</div>
                        <div className="mt-2">Track expenses</div>
                        </div>
                        <div className="col-span-2">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            <a href="javascript:void(0)" className="font-bold hover:text-green-800 hover:underline">Blog and social posts</a>
                            ...
                            <a href="javascript:void(0)" className="font-bold hover:text-green-800 hover:underline">New campaign review</a>
                            <div className="text-sm text-gray-600">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" className="text-gray-800 inline align-middle mr-1" viewBox="0 0 16 16">
                                <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                                </svg>New feedback
                            ...
                            <a href="javascript:void(0)" className="font-bold hover:text-green-800 hover:underline">Cross-platform and browser QA</a>
                            </div>
                        </div>
                    </div>
                </div>
